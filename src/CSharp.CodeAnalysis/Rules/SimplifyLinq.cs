...
namespace SonarQube.CSharp.CodeAnalysis.Rules
{
    ...
    [Tags("clumsy")]
    public class SimplifyLinq : DiagnosticAnalyzer
    {
            ...
            context.RegisterSyntaxNodeAction(
                c =>
                {
                    ...
                    if (outerMethodSymbol == null ||
                        !EmptinessChecking.MethodIsOnIEnumerable(outerMethodSymbol, c.SemanticModel))
                    {
                        return;
                    }
                    ...
                    if (innerMethodSymbol == null ||
                        !EmptinessChecking.MethodIsOnIEnumerable(innerMethodSymbol, c.SemanticModel))
                    {
                        return;
                    }
