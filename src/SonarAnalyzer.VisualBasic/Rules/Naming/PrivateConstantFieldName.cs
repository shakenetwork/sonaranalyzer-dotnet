...
namespace SonarAnalyzer.Rules.VisualBasic
{
    ...
    public sealed class PrivateConstantFieldName : FieldNameChecker
    {
        ...
        internal const string Title = "Private constants should comply with a naming convention";
        internal const string Description =
            "Shared coding conventions allow teams to collaborate efficiently. This rule checks that all \"Private Const\" fields " +
        ...
        [RuleParameter("format", PropertyType.String,
            "Regular expression used to check the private constant names against.", CamelCasingPatternWithOptionalPrefixes)]
