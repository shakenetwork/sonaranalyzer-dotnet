...
namespace SonarAnalyzer.Rules.VisualBasic
{
    ...
    public sealed class PublicConstantFieldName : FieldNameChecker
    {
        ...
        internal const string Title = "Non-private constants should comply with a naming convention";
        internal const string Description =
            "Shared coding conventions allow teams to collaborate efficiently. This rule checks that all non-private \"Const\" fields " +
        ...
        [RuleParameter("format", PropertyType.String,
            "Regular expression used to check the non-private constant names against.", PascalCasingPattern)]
