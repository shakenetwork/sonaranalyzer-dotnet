...
{
    public sealed class EqualsRelationship : BinaryRelationship
    {
        public EqualsRelationship(SymbolicValue leftOperand, SymbolicValue rightOperand)
        ...
        private bool Equals(EqualsRelationship other)
        {
